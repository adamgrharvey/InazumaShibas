    ...
    <>
      ...
      <div className="HomeText fadeInPage">
        ...
        <div><p>  The Shiba was developed in Japan, and is the smallest of the native Japanese breeds. Developed as a hunting dog for boar, rabbit, grouse and other small game in dense undergrowth, the Shiba needed strength, agility and a coarse thick coat, as well as courage and tenacity. While still retaining these hunting skills, the Shiba is now primarily an excellent companion. </p>
          ...
          <p className='font-bold text-2xl mt-5'>General Appearance and Characteristics</p>
          ...
          <p className='font-bold text-2xl mt-5'>Temperament</p>
          ...
          <p className='font-bold mt-5 text-2xl'> The Japanese have three terms to characterise the Shiba's combined intrinsic qualities:  </p>

          <p className='font-bold text-2xl mt-5'>KAN'I</p>
          ...
          <p className='font-bold text-2xl mt-5'>RYOSEI</p>
          ...
          <p className='font-bold text-2xl mt-5'>SOBOKU</p>
          ...
          <p className="mt-5 mb-4">For more information please refer to the CKC Shiba Inu breed standard: <a href="https://www.ckc.ca/CanadianKennelClub/media/Breed-Standards/Group%206/Shiba-Inu.pdf?ext=.pdf"><span>https://www.ckc.ca/CanadianKennelClub/media/Breed-Standards/Group%206/Shiba-Inu.pdf?ext=.pdf</span></a></p></div>
