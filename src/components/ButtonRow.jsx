      ...
      <div>
        ...
        <div className={hamburgerMenu ? 'fadeIn' : 'fadeOut'}>
          <div className='Links'>
            <div>
              <Link to={"/"}>
                <button onClick={() => {setSelected(0); setHamburgerMenu(false)}} className={`button${window.location.pathname === '/' ? '-selected' : ''}`}>Home</button>
              </Link>
              <Link to={"/about-shibas"}>
                <button onClick={() => {setSelected(1); setHamburgerMenu(false)}} className={`button${window.location.pathname === '/about-shibas' ? '-selected' : ''}`}>About Shibas</button>
              </Link>
              <Link to={"/our-shibas"}>
                <button onClick={() => {setSelected(2); setHamburgerMenu(false)}} className={`button${window.location.pathname === '/our-shibas' ? '-selected' : ''}`}>Our Shibas</button>
              </Link>
              <Link to={"/puppies"}>
                <button onClick={() => {setSelected(3); setHamburgerMenu(false)}} className={`button${window.location.pathname === '/puppies' ? '-selected' : ''}`}>Puppies</button>
              </Link>
              <Link to={"/achievements"}>
                <button onClick={() => {setSelected(4); setHamburgerMenu(false)}} className={`button${window.location.pathname === '/achievements' ? '-selected' : ''}`}>Achievements</button>
              </Link>
            </div>
          </div>
        </div>
